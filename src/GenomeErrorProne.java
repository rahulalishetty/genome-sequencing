...
public class GenomeErrorProne{
    ...
    public static String [] reader(){
        ...
        String [] reads = new String[1000];//array to store the reads of the genome.

        for(int i=0;i<reads.length;i++){
            String temp = fr.nextLine();
            reads[i] = temp.trim();
            System.out.println("stored-"+i+reads[i]);
        }

        System.out.println("stored"+reads.length);
        return reads;
    }
    ...
    public static Vertex [] createDeBruijnGraph(String [] reads){
        ...
        for(int i=0;i<reads.length;i++){
            String read = reads[i];
            System.out.println("create debru read:"+ read);
    ...
    public static void findCycle(Vertex [] graph, List<Edge> edges){
        ...
        System.out.println("after loop"+ map.keySet()+result);
        ...
        System.out.println("ans:"+result.substring(14,5410));
    }
